...
{
    public static SCIFIOImgPlus<UnsignedByteType> imageFromJPEGBytes(final byte[] data) throws FormatException, IOException
    {
    ...
    public static byte[] imageToJPEGBytes(final SCIFIOImgPlus<UnsignedByteType> img) throws FormatException, IOException
    {
